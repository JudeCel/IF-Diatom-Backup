...
;(function($) {
	...
	$.fn.fmatter.actions = function(cellval,opts, rwd) {
		...
		if(op.editformbutton){
			...
			str =str+ "<div title='"+$.jgrid.nav.edittitle+"' style='float:left;cursor:pointer;' class='ui-pg-div ui-inline-edit' "+ocl+"><span class='ui-icon ui-icon-folder-open'></span></div>";
