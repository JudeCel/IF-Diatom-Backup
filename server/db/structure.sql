...
) ENGINE=InnoDB AUTO_INCREMENT=319079303 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping events for database 'if'
--

--
-- Dumping routines for database 'if'
--
/*!50003 DROP PROCEDURE IF EXISTS `getNextHi` */;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`localhost` PROCEDURE `getNextHi`(IN numberOfBatches INT)
BEGIN
START TRANSACTION;
...
-- Dump completed on 2015-10-14 16:36:50
