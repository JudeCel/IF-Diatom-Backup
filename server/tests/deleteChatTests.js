...
test('Delete chat', function (t) {
	...
	t.test("Deletes chat", function (t) {
		var params = {
			event_id: eventId
		};
		var resCb = function (data) {
			t.ok(data.deletedReplies, "Deleted replies were returned");
			t.end();
		};
	...
	t.test("Deletes chat without any params", function (t) {
		var params = {};
		var resCb = function (data) {
			t.notOk(data.deletedReplies, "Replies should not be returned");
			t.end();
		};
		var nextCb = function (data) {
	...
	t.test("Deletes chat with incorrect params", function (t) {
		var params = {
			event_id: "should-not-be-string"
		};
		var resCb = function (data) {
			t.notOk(data.deletedReplies, "Replies should not be returned");
			t.end();
...
function run(params, resCb, nextCb) {
	...
	var cmd = require('../handlers/deleteChat.js');
