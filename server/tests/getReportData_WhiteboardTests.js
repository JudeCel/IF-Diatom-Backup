...
test('getReportData_WhiteboardTests.js', function (t) {
    var sessionId = 0;
    var topicId = 0;
    var user1Id = 0;
    var user2Id = 0;
    ...
    t.test("Gets all events of the Topic", function (t) {
        ...
        var resCb = function (result) {
            t.ok(result, "Events were returned");
            ...
            t.equal(result[0].cmd, "deleteall", "Event 1 cmd is correct");
            ...
            t.equal(result[1].cmd, "object", "Event 2 cmd is correct");
            ...
            t.equal(result[2].cmd, "shareresource", "Event 3 cmd is correct");
            t.end();
        };
