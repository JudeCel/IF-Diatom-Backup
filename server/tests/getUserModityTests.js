...
test('Gets user login info', function (t) {
	...
	t.test("Returns user modity data", function (t) {
		var params = {
			login: login,
			password: password
		};
		var resCb = function (data) {
			t.ok(data, "User modity data was returned");
            if(data != undefined)
            {
	...
	t.test("Should not return user modity data if any parameter is not passed (login)", function (t) {
		var params = {
			login: login
		};
		var resCb = function (data) {
    ...
    t.test("Should not return user modity data if any parameter is not passed (password)", function (t) {
        var params = {
            password: password
        };
        var resCb = function (data) {
...
function run(params, resCb, nextCb) {
	...
	var cmd = require('../handlers/getUserModity.js');
